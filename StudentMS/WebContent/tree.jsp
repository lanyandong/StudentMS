...
var treeMenu = [
	...
	{ level:1, name:"信息管理"},
	{ level:2, name:"新闻管理", ico:"images/icon_default.gif",link:"newsManagement.jsp"},
	{ level:2, name:"公告管理", ico:"images/icon_default.gif",link:"announcemen.jsp"},
	{ level:1, name:"系统邮件", ico:"images/icon_default.gif",link:"systemEmail.jsp"},
	{ level:1, name:"网络文件", ico:"images/icon_default.gif",link:"networkFile.jsp"}
];
</script>
<style>
* {
